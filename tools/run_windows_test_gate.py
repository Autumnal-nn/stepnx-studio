...
# View-menu/Alt-wheel zoom regressions (610), and twenty-one editor-UX cleanup
# regressions (631). Losing any hardening regression file must not leave a
# superficially green release.
MINIMUM_TEST_COUNT = 631
EXPECTED_SKIP_ID = (
