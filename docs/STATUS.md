...
- commands do not yet insert or remove collection members;
...
1. extend commands to collection insert/remove/move with ID allocation rules;
2. add property tests and parser/writer fuzzing;
3. implement the isolated NX10 importer;
4. implement folder open/save and validate/generate `LM.NX`;
5. produce the first read-only Qt authoring viewport.
