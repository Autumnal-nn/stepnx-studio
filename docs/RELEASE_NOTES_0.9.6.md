...
Special thanks to [th3y](https://github.com/th3y) for [PR #27](https://github.com/Autumnal-nn/stepnx-studio/pull/27) and the follow-up review and fixes that helped validate and harden the XSanity SSC export path.
